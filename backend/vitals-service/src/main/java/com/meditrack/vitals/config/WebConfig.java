...
public class WebConfig implements WebMvcConfigurer {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("MediTrack AI Vitals Service API")
                .description("Vitals Ingestion and Management API with Kafka Integration")
                .version("1.0.0")
                .contact(new Contact()
            ...
            .servers(List.of(
                ...
                new Server().url("https://api.meditrack.ai/vitals").description("Production Server")
            ));
    }
